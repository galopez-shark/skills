---
name: go-dev-clean-practice
description: "Go development clean practices for go-bricks services — extends the standard NKH1 pr-review with go-bricks framework validation, reuse checks, and layer discipline. Catches reinvented types, raw DB/HTTP usage, wrong layer boundaries, SQL injection risks, error handling bugs, resource leaks, concurrency bugs, and missing go-bricks patterns. Usage: /go-dev-clean-practice pr-review <PR_URL> [LANG] for PR review, /go-dev-clean-practice scan <path> [LANG] for anti-pattern scan"
license: MIT
metadata:
  author: galopez-shark
  version: "2.0.0"
  domain: review
  triggers: go-dev-clean-practice, go dev clean practice, clean code go, go-bricks review
  role: specialist
  scope: code-review
...
# Go Development Clean Practices (go-bricks)
...
#### 1. `/go-dev-clean-practice pr-review <PR_URL> [LANG]` — Full PR review
...
Examples:
- `/go-dev-clean-practice pr-review https://github.com/novopayment/multitenant-banking-api-be-go/pull/27` → report in **Spanish**
- `/go-dev-clean-practice pr-review https://github.com/novopayment/multitenant-banking-api-be-go/pull/27 EN` → report in **English**
...
#### 2. `/go-dev-clean-practice scan <path> [LANG]` — Anti-pattern scan
...
Examples:
- `/go-dev-clean-practice scan internal/modules/accounts` → scan accounts module for anti-patterns, report in **Spanish**
- `/go-dev-clean-practice scan . EN` → scan entire project for anti-patterns, report in **English**
